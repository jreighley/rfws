...
* [`src/rfws/`](src/rfws/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/rfws/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `rfws` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/rfws/config.cljs) defaults to `true` in
